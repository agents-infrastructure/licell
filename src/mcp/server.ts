    ...
    licell_deploy: {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          domain: { type: 'string', description: 'Full custom domain (e.g. api.example.com). API only. Implies SSL.' },
          domainSuffix: { type: 'string', description: 'Domain suffix (e.g. example.com) to bind <appName>.<suffix>. API only.' },
          enableCdn: { type: 'boolean', description: 'Enable CDN after domain bind (API only). Implies SSL.' },
