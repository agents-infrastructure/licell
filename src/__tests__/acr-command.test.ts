...
const { emitCommandResultMock, listAcrInstancesMock, listAcrNamespacesMock, listAcrRepositoriesMock, listAcrTagsMock } = vi.hoisted(() => ({
  emitCommandResultMock: vi.fn(), listAcrInstancesMock: vi.fn(), listAcrNamespacesMock: vi.fn(), listAcrRepositoriesMock: vi.fn(), listAcrTagsMock: vi.fn()
}));
