...
本文件复制到 `.codestable/roadmap/ecs-operations-support/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/ecs-operations-support/goal-state.yaml`
- `.codestable/roadmap/ecs-operations-support/goal-plan.md`
...
- `.codestable/roadmap/ecs-operations-support/goal-features/*.md`
- `.codestable/roadmap/ecs-operations-support/goal-protocol-feature-loop.md`
- `.codestable/roadmap/ecs-operations-support/goal-protocol-gates.md`
- `.codestable/roadmap/ecs-operations-support/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/ecs-operations-support/goal-plan.md
Protocol: .codestable/roadmap/ecs-operations-support/goal-protocol.md
```
