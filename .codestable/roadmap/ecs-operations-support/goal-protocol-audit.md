...
写 `.codestable/roadmap/ecs-operations-support/goal-audit.md`：
...
同时写 `.codestable/roadmap/ecs-operations-support/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
