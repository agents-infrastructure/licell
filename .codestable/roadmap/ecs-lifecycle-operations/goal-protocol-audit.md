...
写 `.codestable/roadmap/ecs-lifecycle-operations/goal-audit.md`：
...
同时写 `.codestable/roadmap/ecs-lifecycle-operations/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
